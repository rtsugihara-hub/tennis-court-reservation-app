...
// ★ 直近（現在日時から最も近い）の予約1件を取得して表示する計算ロジック
scwin.updateLatestReservation = function () {
  ...
  if (futureReservations.length > 0) {
    ...
    // 過去の予約のみの場合は、一番過去の中で最新（今日に一番近い）予約を選択
