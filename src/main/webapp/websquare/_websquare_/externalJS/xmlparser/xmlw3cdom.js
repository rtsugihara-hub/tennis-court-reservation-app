...
DOMImplementation.prototype.loadXML = function DOMImplementation_loadXML(xmlStr) {
  ...
  try {
    parser = new XMLP(xmlStr);
	  ...
	  if( typeof WebSquare != "undefined" && typeof WebSquare.exception != "undefined" && typeof WebSquare.exception.printStackTrace != "undefined" ) {
		  WebSquare.exception.printStackTrace(e, "Error Creating the SAX Parser. Did you include xmlsax.js or tinyxmlsax.js in your web page?\nThe SAX parser is needed to populate XML for <SCRIPT>'s W3C DOM Parser with data.");
	  } else {
		  var str = "";
		for( var idx in e ) {
			var tmp = idx;
...
DOMNodeList.prototype._insertBefore = function DOMNodeList__insertBefore(newChild, refChildIndex) {
  if ((refChildIndex >= 0) && (refChildIndex < this._nodes.length)) { // bounds check
    ...
    this.length = this._nodes.length;            // update length
		...
		// for att[i] __ kim woog lae
		for( var _idx = 0 ; _idx < this.length ; _idx++ ) {
//			alert( "_insertBefore " + _idx + " " + this._nodes[_idx] );
  ...
  if ((refChildIndex >= 0) && (refChildIndex < this._nodes.length)) { // bounds check
    ...
    if (newChild.nodeType == DOMNode.DOCUMENT_FRAGMENT_NODE) {  // node is a DocumentFragment
      ...
      this._nodes[refChildIndex] = newChild;
		...
		// for att[i] __ kim woog lae
		for( var _idx = 0 ; _idx < this.length ; _idx++ ) {
//			alert( "_replaceChild " + _idx + " " + this._nodes[_idx] );
			this[_idx] = this._nodes[_idx];
		}
...
DOMNodeList.prototype._removeChild = function DOMNodeList__removeChild(refChildIndex) {
  ...
  if (refChildIndex > -1) {                              // found it!
    ...
    this.length = this._nodes.length;            // update length
		...
		// for att[i] __ kim woog lae
		for( var _idx = 0 ; _idx < this.length ; _idx++ ) {
//			alert( "_removeChild " + _idx + " " + this._nodes[_idx] );
			this[_idx] = this._nodes[_idx];
		}
  }
...
DOMNodeList.prototype._appendChild = function DOMNodeList__appendChild(newChild) {
  ...
  this.length = this._nodes.length;              // update length
	...
	// for att[i] __ kim woog lae
	for( var _idx = 0 ; _idx < this.length ; _idx++ ) {
//		alert( "_appendChild " + _idx + " " + this._nodes[_idx] );
		this[_idx] = this._nodes[_idx];
	}
};
...
DOMNamedNodeMap.prototype.setNamedItem = function DOMNamedNodeMap_setNamedItem(arg) {
  ...
  this.length = this._nodes.length;              // update length
	...
	// for att[i] __ kim woog lae
	for( var _idx = 0 ; _idx < this.length ; _idx++ ) {
//		alert( "setNamedItem " + _idx + " " + this._nodes[_idx] );
		this[_idx] = this._nodes[_idx];
	}
...
DOMNamedNodeMap.prototype.setNamedItemNS = function DOMNamedNodeMap_setNamedItemNS(arg) {
  ...
  this.length = this._nodes.length;              // update length
	...
	// for att[i] __ kim woog lae
	for( var _idx = 0 ; _idx < this.length ; _idx++ ) {
//		alert( "setNamedItemNS " + _idx + " " + this._nodes[_idx] );
		this[_idx] = this._nodes[_idx];
	}
...
DOMDocumentType = function() {
  if( typeof WebSquare != "undefined" && typeof WebSquare.logger != "undefined" && typeof WebSquare.logger.printLog != "undefined" ) {
      WebSquare.logger.printLog("DOMDocumentType.constructor(): Not Implemented");
  }
};
DOMEntity = function() {
  if( typeof WebSquare != "undefined" && typeof WebSquare.logger != "undefined" && typeof WebSquare.logger.printLog != "undefined" ) {
      WebSquare.logger.printLog("DOMEntity.constructor(): Not Implemented");
  }
};
DOMEntityReference = function() {
  if( typeof WebSquare != "undefined" && typeof WebSquare.logger != "undefined" && typeof WebSquare.logger.printLog != "undefined" ) {
      WebSquare.logger.printLog("DOMEntityReference.constructor(): Not Implemented");
  }
};
DOMNotation = function() {
  if( typeof WebSquare != "undefined" && typeof WebSquare.logger != "undefined" && typeof WebSquare.logger.printLog != "undefined" ) {
      WebSquare.logger.printLog("DOMNotation.constructor(): Not Implemented");
  }  
};
