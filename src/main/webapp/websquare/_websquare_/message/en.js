var WebSquareLang = {
    ...
    E_date_minute_ShouldBeyyMMddmmFormat: "Input in yyyyMMddHHmm format. Your input is %1.",
    ...
    //pageInfo.js
    E_pageInfo_MoreThanOneBodyError: "WebSquare allows only one <body> tag in the XML file. \n But this file has '%1' <body> tags.",
    //xml.js
    ...
    //validator
    V_error_minLength: "Enter at least %1 digit(s).",
    V_error_maxLength: "Cannot exceed %1 digit(s).",
    V_error_maxFloatLength: "Cannot exceed %1 integer digit(s) and %2 decimal digit(s).",
    V_error_minByteLength: "Enter at least %1 byte(s).",
    V_error_maxByteLength: "Cannot exceed %1 byte(s).",
    ...
    Calendar_ok: "OK",
    Calendar_open: "Select from calendar",
    ...
    Calendar_info2: "Since the calendarValueType option of %1 is 'yearMonth', the strings that can be used as arguments for the setDateFormat API are yyyy, MM.",
    ...
    MultiUpload_err_HTTPExcpetion: "HTTP error occurred. (status : %1)",
    ...
    WindowContainer_next: "Next window",
    WindowContainer_previous: "Previous window",
    ...
    WidgetContainer_split: "split",
    WidgetContainer_split_placeholder: "Split",
    // DatePicker
    ...
    TabControl_tab_close: "Close tab %1",
    ...
    Grid_filter_condition_no_equal: "Not Equal",
    ...
    Grid_filter_info_Label2: "* matches zero or more characters.",
    ...
    Grid_warning11: "The data size has exceeded the limit.\n The current limit is : %1 bytes",
    ...
    Upload_msg2: "File size exceeds the limit.",
    Upload_msg3: "Normal processing failed.",
    Upload_msg4: "File extension does not match FileType.",
    ...
    Upload_msg9: "File extension is not allowed.",
    Upload_msg10: "An error occurred during DRM.",
    Upload_msg11: "Row count exceeds the limit.",
    Upload_msg12: "Invalid file format.",
    Upload_msg13: "Invalid cell format",
    Upload_msg14: "Cell count exceeds the limit.",
    Upload_msg15: "This file is encrypted.",
    Upload_msg16: "Excel 5.0/7.0 is not supported.",
    Upload_msg17: "The specified sheet does not exist.",
    Upload_msg18: "It is a write-only file or an unreadable file.",
    Upload_warning1: "This feature is disabled for security reasons.",
    //datalist
    ...
    //treeview
    Treeview_iconNaviAriaLabel: "Expand/Collapse button",
